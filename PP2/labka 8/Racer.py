...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("images/racer1.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("images/Pygame_rects.png")
        self.rect = self.image.get_rect()
        self.rect.center = (160, HEIGHT - 80)
...
class Coins(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("images/cion.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, WIDTH - 40), 0)
...
while True:
    ...
    screen.blit(coin_score, (WIDTH - 200, 10))
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("audio/music_for_the_racer.mp3").play()
        time.sleep(0.5)
