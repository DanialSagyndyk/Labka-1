...
'''
в этой игре когда нажимаете esc игра останавливается и если нажать мышкой на settings вы зайдете внутрь 
и кнопкой вверх и вниз можете регулировать радиус мяча и что бы обратно вернуться нажмите обратно esc
'''
pygame.init()
W, H = 1200, 800
is_paused = False
...
collision_sound = pygame.mixer.Sound('labka 9/audio/catch.mp3')
